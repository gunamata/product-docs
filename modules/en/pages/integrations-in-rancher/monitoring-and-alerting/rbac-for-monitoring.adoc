...
image::/img/cluster-compute-resources-dashboard.png[Cluster Compute Resources Dashboard in Grafana]+++<figcaption>+++Default Dashboards in Grafana+++</figcaption>+++

image::/img/grafana-default-dashboard.png[Default Dashboards in Grafana]
